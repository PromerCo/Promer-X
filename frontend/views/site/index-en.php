...
<body class="kenburns-background vegas-container">
    <div class="vegas-slide vegas-transition-swirlLeft2 vegas-transition-swirlLeft2-in vegas-transition-swirlLeft2-out"
        style="transition: all 4000ms ease 0s;">
        <div class="vegas-slide-inner"
            style="background-image: url(./images/promer.co.prometheus.jpg); background-color: rgb(255, 255, 255); background-position: center top; background-size: cover;">
        </div>
    </div>
    <div class="vegas-slide vegas-transition-swirlLeft2 vegas-transition-swirlLeft2-in vegas-transition-swirlLeft2-out"
        style="transition: all 4000ms ease 0s;">
        <div class="vegas-slide-inner"
            style="background-image: url(./images/promer.co.internet.jpg); background-color: rgb(255, 255, 255); background-position: center top; background-size: cover;">
        </div>
    </div>
    ...
    <header class="site-header header-mobile-dark header-content-light header-content-mobile-light">
        <div class="header-brand">
            <!-- logo -->
            <a class="logo" href="/">
                <img src="images/promer.co.logo.png" alt="">
            </a>
                    ...
                    <div class="container align-self-center text-white">
                        <div class="row mb-5 text-center">
                            <div class="col-12 col-lg-9 mx-lg-auto">
                                ...
                                <div data-animation="fadeInUp" data-animation-delay="200" class="services">
                                    <ul>
                                        <li>
